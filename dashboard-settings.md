...
{{site.data.keyword.messages-for-rabbitmq}} is provisioned with a default admin user. You can set or change the admin password of your deployment by using _Update Password_.
