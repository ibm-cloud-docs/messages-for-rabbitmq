...
Use the following command to review the value of the `host_flavor` attribute. This value will be null if the database is on a deprecated hosting model (not Shared or Isolated Compute).
