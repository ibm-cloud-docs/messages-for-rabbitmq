...
```
ibmcloud resource service-instance-create SERVICE_INSTANCE_NAME messages-for-rabbitmq standard REGION -p '{"backup_id":"BACKUP_ID"}'
```
...
```
ibmcloud cdb backup-show crn:v1:staging:public:messages-for-rabbitmq:us-south:a/6284014dd5b487c87a716f48aeeaf99f:3b4537bf-a585-4594-8262-2b1e24e2701e:backup:a3364821-d061-413f-a0df-6ba0e2951566
```
{: codeblock}
